...
The mean total number of steps per day is `r meanperday` and the median total number of steps per day is `r medianperday`
...
The total number of rows with NA values is `r numNA`
